...
class calendarScreen(Screen):
    ...
    def go_to_next_month(self, instance):
        ...
        self.prev_month_button = Button(
            text="<",
            background_color=("blue"),
            background_normal="",
            on_press=self.go_to_previous_month
        )
        ...
        self.next_month_button = Button(
            ...
            background_color=("blue"),
            background_normal="",
            on_press=self.go_to_next_month
        )

    def update_month(self):
        month_label = f"{calendar.month_name[self.month]} {self.year}"
        days_in_month = calendar.monthrange(self.year, self.month)[1]
        self.layout.clear_widgets()
        self.layout.add_widget(month_label)
        self.layout.add_widget(self.prev_month_button)
        self.layout.add_widget(self.next_month_button)
        self.day_buttons = []
